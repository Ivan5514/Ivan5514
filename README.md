...
<a href="certificados/" target="_blank" class="btn-certificados">
📜 Ver Certificados
</a>
...
background:linear-gradient(45deg,#1b5e20,#2e7d32,#66bb6a);
background-size:300%;

box-shadow:0 5px 15px rgba(0,0,0,0.3);
transition:all 0.3s ease;

animation:gradientMoveCert 3s infinite;
}
...
<a href="pdf/" target="_blank" class="btn-cv">
📄 Ver CV en PDF
</a>
...
background:linear-gradient(45deg,#ff3d00,#ff0000,#ff5252);
background-size:300%;
